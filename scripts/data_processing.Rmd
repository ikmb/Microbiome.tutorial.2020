...
#setwd("~/IKMB/projects/random/Microbiome.tutorial.2020/scripts")
```
...
tax.mock <- data.frame(assignTaxonomy(seqtab.mock, "../data/rdp_train_set_16.fa.gz", multithread=4))
